---
layout: post
title: "Training an LLM in WASM from scratch"
date: 2025-12-21 13:45:00
categories: blog
tags: machine-learning
---

> [Try the demo here](/assets/lm-visualizer/index.html)
...
#### Pivoting
To train my own GPT-2, I need to do it on an actual NVIDIA GPU. Doing the math - GPT-2 is roughly 10^19 FLOPS required.  A NVIDIA A100 can do 93 TFLOPS, and an 8 node A100 on lambda labs can thus do 744 TFLOPS (7 × 10^14).  That would take 4 hours to train, roughly 50$ on [Lambda Labs](https://lambda.ai/). Very doable!
